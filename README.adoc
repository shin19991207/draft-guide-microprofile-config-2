...
You will learn to embed config property values inside of other config property values, retrieve details about a given config property, retrieve multi-valued config property values as a List, using the new built-in Converters, and inject related config property values with a shared prefix into a CDI bean.
...
// =================================================================================================
// Configuring microservices with multiple Config Profiles
// =================================================================================================
== Configuring microservices with multiple Config Profiles
...
// =================================================================================================
// Injecting configuration properties with the proper converter
// =================================================================================================
== Injecting configuration properties with the proper converter
...
If a configuration property cannot be found in any of the config sources and there is neither default value nor property is not optional, `java.util.NoSuchElementException` will be thrown. You can use `Optional<T>` or `OptionalInt`, `OptionalDouble`, `OptionalLong` as the type to avoid such exception.
...
[source, Java, linenums, role='code_column hide_tags=getCheckBackTime']
----
